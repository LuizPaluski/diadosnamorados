...
const Navigation = () => {
  ...
  const navLinks = [
    ...
    { to: '/diary', text: 'Nosso Diário' }, // <<< LINK ADICIONADO AQUI
    { to: '/future-dreams', text: 'Nossos Sonhos' },
  ];

  // Apenas para garantir a ordem correta no menu
  const menuOrder = ['/', '/our-story', '/gallery', '/letters', '/quiz', '/diary', '/future-dreams'];
